      ...
      const stats = await User.findAll({
        attributes: [
          [
            sequelize.fn(
              "COUNT",
              sequelize.literal('CASE WHEN role = "company_admin" THEN 1 END'),
            ),
            "adminCount",
          ],
          [
            sequelize.fn(
              "COUNT",
              sequelize.literal('CASE WHEN role = "hr" THEN 1 END'),
            ),
            "hrCount",
          ],
          [
            sequelize.fn(
              "COUNT",
              sequelize.literal('CASE WHEN role = "employee" THEN 1 END'),
            ),
            "employeeCount",
          ],
          [
          ...
          [
            sequelize.fn(
              "COUNT",
              sequelize.literal("CASE WHEN is_active = false THEN 1 END"),
            ),
            "inactiveCount",
          ],
